...
using GlobusCustomerAPI.Data.Repository;

namespace GlobusCustomerAPI.Data.Helpers
{
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<GlobusDbContext, object>> GetFactories()
        {
            return new Dictionary<Type, Func<GlobusDbContext, object>>
                {
        ...
        /// </remarks>
        public RepositoryFactories(IDictionary<Type, Func<GlobusDbContext, object>> factories)
        {
        ...
        /// </remarks>
        public Func<GlobusDbContext, object> GetRepositoryFactory<T>()
        {

            Func<GlobusDbContext, object> factory;
        ...
        /// </remarks>
        public Func<GlobusDbContext, object> GetRepositoryFactoryForEntityType<T>() where T : class
        {
        ...
        /// </remarks>
        private readonly IDictionary<Type, Func<GlobusDbContext, object>> _repositoryFactories;
    }
}
