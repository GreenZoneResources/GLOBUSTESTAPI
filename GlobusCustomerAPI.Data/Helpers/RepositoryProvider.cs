...
namespace GlobusCustomerAPI.Data.Helpers
{
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </summary>
        public GlobusDbContext DbContext { get; set; }
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<GlobusDbContext, object> factory = null) where T : class
        {
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<GlobusDbContext, object> factory, GlobusDbContext dbContext)
        {
